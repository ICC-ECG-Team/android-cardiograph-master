...
//		String versionCode = "";
//		try {
//			PackageManager pm = ApplicationEx.getInstance()
//					.getPackageManager();
//
//			PackageInfo pi = pm.getPackageInfo(ApplicationEx
...
//		String CHANNELID = "0";
//		try {
//			ApplicationInfo ai = ApplicationEx
//					.getInstance()
//					.getPackageManager()
//					.getApplicationInfo(
//							ApplicationEx.getInstance().getPackageName(),
