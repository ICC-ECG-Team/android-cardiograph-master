...
import com.icc.cardiograph.component.MyProgressDialog;
import com.icc.cardiograph.component.NavigationBar;
import com.icc.cardiograph.constance.Constance;
import com.icc.cardiograph.thread.RequestTask;
import com.icc.cardiograph.util.PreferencesUtil;
...
//		editor= sp.edit();
	...
	private void update() {
		...
		new RequestTask(Constance.URL_UPDATE, Constance.POST, nvpList, new RequestTask.ResponseCallBack() {
			@Override
